...
async def get_help(interaction):
    ...
    embed.add_field(name="feedback", value="Hall of Fame Bot is open source, and we are always looking for feedback and suggestions. Please let us know if you have any ideas or suggestions for new features or improvements.", inline=False)
