...
LEADERBOARD_NO_DATA = "No data available for the leaderboard. Data is calculated every 24 hours."
PROFILE_NO_DATA = "No data available for this user. Data is calculated every 24 hours."
